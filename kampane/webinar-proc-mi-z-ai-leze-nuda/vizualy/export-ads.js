  ...
  const exports = [
    {
      ...
      names: ['square-1-hero-claim', 'square-2-pain-point', 'square-3-prepisujes', 'square-4-nejsi-sama', 'square-5-vision', 'square-6-program'],
      vw: 1200,
      vh: 8000,
    },
    {
      ...
      names: ['story-1-hero-claim', 'story-2-pain-point', 'story-3-prepisujes', 'story-4-nejsi-sama', 'story-5-vision', 'story-6-program'],
      vw: 1200,
      vh: 14000,
    },
  ];
